...
public class MinIntHeap {
  ...
  public void heapifyUp() {
    ...
    while(hasParent(index) && parent(index)
        > items[index]) {  // walk up as long as there is a parent and it is bigger than you
  ...
  public void heapifyDown() {
    ...
    while(hasLeftChild(
        index)) {  // as long as I have children Note: Only need to check left because if no left, there is no right
